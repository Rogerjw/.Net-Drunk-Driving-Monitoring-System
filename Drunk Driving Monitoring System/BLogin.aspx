<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="BLogin.aspx.cs" Inherits="Drunk_Driving_Monitoring_System.BLogin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div align="center">
        <br />
        <h3><strong>Bar Owner Login </strong></h3>
        <br />
    </div>
    <div align="center">
        <table width="30%">
    ...
    <div align="center">
        <br />
        <h4>Not Login yet? <a style="color:dodgerblue" href="RegisterBarOwner.aspx"> Register here</a></h4>
        <br /><br />
    </div>
</asp:Content>
