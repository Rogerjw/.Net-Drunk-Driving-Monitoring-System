<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ViewWarnings.aspx.cs" Inherits="Drunk_Driving_Monitoring_System.ViewWarnings" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div align="center">
        <br />
            <h1><strong>View Warnings</strong></h1>
        <br />
    </div>
    <div align="center">
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" Width="60%" ForeColor="#333333" GridLines="None">
